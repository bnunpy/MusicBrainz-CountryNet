...
## Notebooks
<p>**1. test_scrape_releases.ipynb**
...
* Writes a text file (delimiter: `'<--->'`) to cwd with each line repesenting the artists credited for a single release (e.g., a single, EP, or full album) with the last elemet being the number of songs in the release.</p>
  
<p>**2. df_extract_node_attrs.ipynb**
 ...
 * Pickles the dictionary</p>
  
<p>**3. make_network.ipynb**
...
* **Visualization** with `pyvis.network` at the end of this notebook.</p>
